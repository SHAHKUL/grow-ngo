...
import Grow from "../image/Growth and wisdom symbolized.png"
...
const Navbar = () => {
  ...
  <div className="flex flex-col">
    <div className="text-grow-green font-bold text-xl sm:text-2xl">
      GROW
    </div>
    <div className="text-gray-600 font-medium text-xs sm:text-sm hidden sm:block">
      (Grasping Resources, Offering Wisdom)
    </div>
  </div>

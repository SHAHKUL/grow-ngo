  ...
  const faqs = [
    {
      ...
      answer: 'You can fill out our volunteer application form on the Get Involved page. We\'ll review your application and contact you about available opportunities.'
    },
    {
      question: 'Where does my donation go?',
      answer: '85% of donations go directly to program implementation, 10% to administrative costs, and 5% to fundraising. We provide regular reports on how funds are utilized.'
    },
    {
      question: 'Can I visit your project sites?',
      answer: 'Yes! We organize regular site visits for donors and volunteers. Please contact us in advance to schedule a visit.'
    },
    {
      question: 'How can I partner with GROW Foundation?',
      answer: 'We welcome partnerships with corporations, NGOs, academic institutions, and government agencies. Please fill out the partnership inquiry form on our Get Involved page.'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              We're here to answer your questions and discuss how you can get involved
            </p>
          </div>
